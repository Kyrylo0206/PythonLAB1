...
# Масштабування з використанням OpenCV
...
# Обертання з використанням OpenCV
theta = 45  # градуси
...
image = cv2.cvtColor(image, cv2.COLOR_BGR2RGB)  # Перетворення BGR у RGB для коректного відображення з matplotlib
...
scaled_image = cv2.warpAffine(image, scale_matrix, (image.shape[1] // 2, image.shape[0] // 2))
